...
class QGeoAddress(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtPositioning.QGeoAddress: ...
...
class QGeoAreaMonitorInfo(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtPositioning.QGeoAreaMonitorInfo: ...
...
class QGeoAreaMonitorSource(PySide6.QtCore.QObject):
    ...
    def requestUpdate(self, monitor: PySide6.QtPositioning.QGeoAreaMonitorInfo | str, signal: str, /) -> bool: ...
...
class QGeoCircle(PySide6.QtPositioning.QGeoShape):
    ...
    def __copy__(self, /) -> PySide6.QtPositioning.QGeoCircle: ...
...
class QGeoCoordinate(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtPositioning.QGeoCoordinate: ...
...
class QGeoLocation(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtPositioning.QGeoLocation: ...
...
class QGeoPath(PySide6.QtPositioning.QGeoShape):
    ...
    def __copy__(self, /) -> PySide6.QtPositioning.QGeoPath: ...
    def __lshift__(self, stream: PySide6.QtCore.QDataStream, /) -> PySide6.QtCore.QDataStream: ...
    def __rshift__(self, stream: PySide6.QtCore.QDataStream, /) -> PySide6.QtCore.QDataStream: ...
...
class QGeoPolygon(PySide6.QtPositioning.QGeoShape):
    ...
    def __copy__(self, /) -> PySide6.QtPositioning.QGeoPolygon: ...
    def __lshift__(self, stream: PySide6.QtCore.QDataStream, /) -> PySide6.QtCore.QDataStream: ...
    def __rshift__(self, stream: PySide6.QtCore.QDataStream, /) -> PySide6.QtCore.QDataStream: ...
    def addCoordinate(self, coordinate: PySide6.QtPositioning.QGeoCoordinate, /) -> None: ...
    @typing.overload
...
class QGeoPositionInfo(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtPositioning.QGeoPositionInfo: ...
...
class QGeoRectangle(PySide6.QtPositioning.QGeoShape):
    ...
    def __copy__(self, /) -> PySide6.QtPositioning.QGeoRectangle: ...
...
class QGeoSatelliteInfo(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtPositioning.QGeoSatelliteInfo: ...
...
class QGeoShape(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtPositioning.QGeoShape: ...
...
class QNmeaPositionInfoSource(PySide6.QtPositioning.QGeoPositionInfoSource):
    ...
    def minimumUpdateInterval(self, /) -> int: ...
    @typing.overload
    def parsePosInfoFromNmeaData(self, data: str, size: int, posInfo: PySide6.QtPositioning.QGeoPositionInfo, /) -> typing.Tuple[bool, bool]: ...
    @typing.overload
    def parsePosInfoFromNmeaData(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, posInfo: PySide6.QtPositioning.QGeoPositionInfo, /) -> typing.Tuple[bool, bool]: ...
    def requestUpdate(self, /, timeout: int | None = ...) -> None: ...
...
class QNmeaSatelliteInfoSource(PySide6.QtPositioning.QGeoSatelliteInfoSource):
    ...
    def minimumUpdateInterval(self, /) -> int: ...
    @typing.overload
    def parseSatelliteInfoFromNmea(self, data: str, size: int, infos: collections.abc.Sequence[PySide6.QtPositioning.QGeoSatelliteInfo], system: PySide6.QtPositioning.QGeoSatelliteInfo.SatelliteSystem, /) -> PySide6.QtPositioning.QNmeaSatelliteInfoSource.SatelliteInfoParseStatus: ...
    @typing.overload
    def parseSatelliteInfoFromNmea(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, infos: collections.abc.Sequence[PySide6.QtPositioning.QGeoSatelliteInfo], system: PySide6.QtPositioning.QGeoSatelliteInfo.SatelliteSystem, /) -> PySide6.QtPositioning.QNmeaSatelliteInfoSource.SatelliteInfoParseStatus: ...
    @typing.overload
    def parseSatellitesInUseFromNmea(self, data: str, size: int, pnrsInUse: collections.abc.Sequence[int], /) -> PySide6.QtPositioning.QGeoSatelliteInfo.SatelliteSystem: ...
    @typing.overload
    def parseSatellitesInUseFromNmea(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, pnrsInUse: collections.abc.Sequence[int], /) -> PySide6.QtPositioning.QGeoSatelliteInfo.SatelliteSystem: ...
    def requestUpdate(self, /, timeout: int | None = ...) -> None: ...
    def setBackendProperty(self, name: str, value: typing.Any, /) -> bool: ...
    def setDevice(self, source: PySide6.QtCore.QIODevice, /) -> None: ...
