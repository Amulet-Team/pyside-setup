...
class QSqlDatabase(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtSql.QSqlDatabase: ...
...
class QSqlError(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtSql.QSqlError: ...
...
class QSqlField(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtSql.QSqlField: ...
...
class QSqlIndex(PySide6.QtSql.QSqlRecord):
    ...
    def __copy__(self, /) -> PySide6.QtSql.QSqlIndex: ...
    @typing.overload
...
class QSqlQuery(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtSql.QSqlQuery: ...
...
class QSqlRecord(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtSql.QSqlRecord: ...
...
class QSqlRelation(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtSql.QSqlRelation: ...
