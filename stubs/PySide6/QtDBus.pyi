...
class QDBus(shiboken6.Shiboken.Object):
...
class QDBusAbstractInterface(PySide6.QtDBus.QDBusAbstractInterfaceBase):
    ...
    @typing.overload
    def callWithCallback(self, method: str, args: collections.abc.Sequence[typing.Any], receiver: PySide6.QtCore.QObject, member: str, /) -> bool: ...
    @typing.overload
    def callWithCallback(self, method: str, args: collections.abc.Sequence[typing.Any], receiver: PySide6.QtCore.QObject, member: str, errorSlot: str, /) -> bool: ...
    ...
    def internalPropGet(self, propname: str, /) -> typing.Any: ...
    def internalPropSet(self, propname: str, value: typing.Any, /) -> None: ...
...
class QDBusArgument(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtDBus.QDBusArgument: ...
    @typing.overload
    ...
    @typing.overload
    def __lshift__(self, arg: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtDBus.QDBusArgument: ...
    @typing.overload
    ...
    @typing.overload
    def __rshift__(self, arg: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtDBus.QDBusArgument: ...
    @typing.overload
...
class QDBusConnection(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtDBus.QDBusConnection: ...
    ...
    @typing.overload
    def callWithCallback(self, message: PySide6.QtDBus.QDBusMessage, receiver: PySide6.QtCore.QObject, returnMethod: str, errorMethod: str, /, timeout: int = ...) -> bool: ...
    @typing.overload
    def callWithCallback(self, message: PySide6.QtDBus.QDBusMessage, receiver: PySide6.QtCore.QObject, slot: str, /, timeout: int = ...) -> bool: ...
    @typing.overload
    def connect(self, service: str, path: str, interface: str, name: str, receiver: PySide6.QtCore.QObject, slot: str, /) -> bool: ...
    @typing.overload
    def connect(self, service: str, path: str, interface: str, name: str, signature: str, receiver: PySide6.QtCore.QObject, slot: str, /) -> bool: ...
    @typing.overload
    def connect(self, service: str, path: str, interface: str, name: str, argumentMatch: collections.abc.Sequence[str], signature: str, receiver: PySide6.QtCore.QObject, slot: str, /) -> bool: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    def disconnect(self, service: str, path: str, interface: str, name: str, receiver: PySide6.QtCore.QObject, slot: str, /) -> bool: ...
    @typing.overload
    def disconnect(self, service: str, path: str, interface: str, name: str, signature: str, receiver: PySide6.QtCore.QObject, slot: str, /) -> bool: ...
    @typing.overload
    def disconnect(self, service: str, path: str, interface: str, name: str, argumentMatch: collections.abc.Sequence[str], signature: str, receiver: PySide6.QtCore.QObject, slot: str, /) -> bool: ...
    @staticmethod
    ...
    def internalPointer(self, /) -> shiboken6.Shiboken.VoidPtr | None: ...
...
class QDBusContext(shiboken6.Shiboken.Object):
    @typing.overload
    def __init__(self, /) -> None: ...
    @typing.overload
    def __init__(self, QDBusContext: PySide6.QtDBus.QDBusContext, /) -> None: ...

    def __copy__(self, /) -> PySide6.QtDBus.QDBusContext: ...
...
class QDBusError(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtDBus.QDBusError: ...
...
class QDBusMessage(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtDBus.QDBusMessage: ...
...
class QDBusObjectPath(shiboken6.Shiboken.Object):
    @typing.overload
    def __init__(self, /) -> None: ...
    @typing.overload
    ...
    def __copy__(self, /) -> PySide6.QtDBus.QDBusObjectPath: ...
...
class QDBusPendingCall(shiboken6.Shiboken.Object):
...
class QDBusReply(shiboken6.Shiboken.Object):
    @typing.overload
    def __init__(self, /) -> None: ...
    @typing.overload
...
class QDBusSignature(shiboken6.Shiboken.Object):
    @typing.overload
    def __init__(self, /) -> None: ...
    @typing.overload
...
class QDBusUnixFileDescriptor(shiboken6.Shiboken.Object):
    @typing.overload
    def __init__(self, /) -> None: ...
    @typing.overload
    ...
    def __copy__(self, /) -> PySide6.QtDBus.QDBusUnixFileDescriptor: ...
...
class QDBusVariant(shiboken6.Shiboken.Object):
    @typing.overload
    def __init__(self, /) -> None: ...
    @typing.overload
    ...
    def __copy__(self, /) -> PySide6.QtDBus.QDBusVariant: ...
