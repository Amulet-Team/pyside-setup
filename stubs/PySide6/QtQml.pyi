...
class QJSEngine(PySide6.QtCore.QObject):
    ...
    def installExtensions(self, extensions: PySide6.QtQml.QJSEngine.Extension, /, object: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int = ...) -> None: ...
    ...
    def registerModule(self, moduleName: str, value: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, /) -> bool: ...
    ...
    @typing.overload
    def throwError(self, error: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, /) -> None: ...
...
class QJSManagedValue(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, value: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, engine: PySide6.QtQml.QJSEngine, /) -> None: ...
    @typing.overload
    ...
    def callWithInstance(self, instance: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, /, arguments: collections.abc.Sequence[PySide6.QtQml.QJSValue] = ...) -> PySide6.QtQml.QJSValue: ...
    @typing.overload
    ...
    @typing.overload
    def setProperty(self, name: str, value: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, /) -> None: ...
    @typing.overload
    def setProperty(self, arrayIndex: int, value: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, /) -> None: ...
...
class QJSPrimitiveValue(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, type: PySide6.QtCore.QMetaType | PySide6.QtCore.QMetaType.Type, value: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, /) -> None: ...
    @typing.overload
    ...
    def __copy__(self, /) -> PySide6.QtQml.QJSPrimitiveValue: ...
...
class QJSValue(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtQml.QJSValue: ...
    ...
    def callWithInstance(self, instance: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, /, args: collections.abc.Sequence[PySide6.QtQml.QJSValue] = ...) -> PySide6.QtQml.QJSValue: ...
    def deleteProperty(self, name: str, /) -> bool: ...
    def equals(self, other: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, /) -> bool: ...
    ...
    @typing.overload
    def setProperty(self, arrayIndex: int, value: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, /) -> None: ...
    def setPrototype(self, prototype: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, /) -> None: ...
    def strictlyEquals(self, other: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, /) -> bool: ...
...
class QQmlApplicationEngine(PySide6.QtQml.QQmlEngine):
    ...
    def loadData(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, url: PySide6.QtCore.QUrl | str = ...) -> None: ...
...
class QQmlComponent(PySide6.QtCore.QObject):
    ...
    def setData(self, arg__1: PySide6.QtCore.QByteArray | bytes | bytearray | str, baseUrl: PySide6.QtCore.QUrl | str, /) -> None: ...
...
class QQmlContext(PySide6.QtCore.QObject):
    ...
    class PropertyPair(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtQml.QQmlContext.PropertyPair: ...
...
class QQmlError(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtQml.QQmlError: ...
...
class QQmlFile(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def connectDownloadProgress(self, arg__1: PySide6.QtCore.QObject, arg__2: str, /) -> bool: ...
    @typing.overload
    def connectDownloadProgress(self, arg__1: PySide6.QtCore.QObject, arg__2: int, /) -> bool: ...
    @typing.overload
    def connectFinished(self, arg__1: PySide6.QtCore.QObject, arg__2: str, /) -> bool: ...
    @typing.overload
...
class QQmlListReference(shiboken6.Shiboken.Object):
    ...
    def __init__(self, /) -> None: ...
    @typing.overload
    def __init__(self, o: PySide6.QtCore.QObject, property: str, /) -> None: ...
    @typing.overload
    def __init__(self, o: PySide6.QtCore.QObject, property: str, engine: PySide6.QtQml.QQmlEngine, /) -> None: ...
    @typing.overload
    ...
    def __copy__(self, /) -> PySide6.QtQml.QQmlListReference: ...
...
class QQmlProperty(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtQml.QQmlProperty: ...
    def __eq__(self, arg__1: PySide6.QtQml.QQmlProperty | PySide6.QtCore.QObject, /) -> bool: ...
    def __hash__(self, /) -> int: ...
    @typing.overload
    def connectNotifySignal(self, dest: PySide6.QtCore.QObject, slot: str, /) -> bool: ...
    @typing.overload
...
class QQmlScriptString(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtQml.QQmlScriptString: ...
...
def qmlRegisterSingletonInstance(type_obj: type, uri: str, version_major: int, version_minor: int, qml_name: str, callback: object, /) -> int: ...
@typing.overload
def qmlRegisterSingletonType(uri: str, version_major: int, version_minor: int, qml_name: str, callback: object, /) -> int: ...
@typing.overload
def qmlRegisterSingletonType(type_obj: type, uri: str, version_major: int, version_minor: int, qml_name: str, /) -> int: ...
@typing.overload
def qmlRegisterSingletonType(type_obj: type, uri: str, version_major: int, version_minor: int, qml_name: str, callback: object, /) -> int: ...
@typing.overload
def qmlRegisterSingletonType(url: PySide6.QtCore.QUrl | str, uri: str, versionMajor: int, versionMinor: int, qmlName: str, /) -> int: ...
@typing.overload
def qmlRegisterType(type_obj: type, uri: str, version_major: int, version_minor: int, qml_name: str, /) -> int: ...
@typing.overload
def qmlRegisterType(url: PySide6.QtCore.QUrl | str, uri: str, versionMajor: int, versionMinor: int, qmlName: str, /) -> int: ...
