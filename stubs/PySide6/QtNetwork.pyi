...
class QAuthenticator(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QAuthenticator: ...
...
class QDnsDomainNameRecord(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QDnsDomainNameRecord: ...
    def name(self, /) -> str: ...
...
class QDnsHostAddressRecord(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QDnsHostAddressRecord: ...
    def name(self, /) -> str: ...
...
class QDnsMailExchangeRecord(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QDnsMailExchangeRecord: ...
...
class QDnsServiceRecord(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QDnsServiceRecord: ...
    def name(self, /) -> str: ...
    def port(self, /) -> int: ...
...
class QDnsTextRecord(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QDnsTextRecord: ...
    def name(self, /) -> str: ...
...
class QDnsTlsAssociationRecord(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QDnsTlsAssociationRecord: ...
...
class QDtls(PySide6.QtCore.QObject):
    ...
    def decryptDatagram(self, socket: PySide6.QtNetwork.QUdpSocket, dgram: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtCore.QByteArray: ...
    def doHandshake(self, socket: PySide6.QtNetwork.QUdpSocket, /, dgram: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> bool: ...
    ...
    def writeDatagramEncrypted(self, socket: PySide6.QtNetwork.QUdpSocket, dgram: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> int: ...
...
class QDtlsClientVerifier(PySide6.QtCore.QObject):
    class GeneratorParameters(shiboken6.Shiboken.Object):
        ...
        def __init__(self, /) -> None: ...
        @typing.overload
        def __init__(self, a: PySide6.QtCore.QCryptographicHash.Algorithm, s: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
        @typing.overload
        def __init__(self, GeneratorParameters: PySide6.QtNetwork.QDtlsClientVerifier.GeneratorParameters, /) -> None: ...

        def __copy__(self, /) -> PySide6.QtNetwork.QDtlsClientVerifier.GeneratorParameters: ...
    ...
    def verifyClient(self, socket: PySide6.QtNetwork.QUdpSocket, dgram: PySide6.QtCore.QByteArray | bytes | bytearray | str, address: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, port: int, /) -> bool: ...
...
class QFormDataPartBuilder(shiboken6.Shiboken.Object):
    ...
    def setBody(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, fileName: str = ..., mimeType: str = ...) -> PySide6.QtNetwork.QFormDataPartBuilder: ...
...
class QHostAddress(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QHostAddress: ...
    @typing.overload
...
class QHostInfo(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QHostInfo: ...
    @staticmethod
    ...
    @typing.overload  # type: ignore[misc, overload-cannot-match]
    @staticmethod
    def lookupHost(name: str, receiver: PySide6.QtCore.QObject, member: str, /) -> int: ...  # type: ignore[misc, overload-cannot-match]
...
class QHstsPolicy(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QHstsPolicy: ...
...
class QHttp1Configuration(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QHttp1Configuration: ...
...
class QHttp2Configuration(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QHttp2Configuration: ...
...
class QHttpHeaders(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QHttpHeaders: ...
    @typing.overload
    ...
    @staticmethod
    def fromListOfPairs(headers: collections.abc.Sequence[typing.Tuple[typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray], typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray]]], /) -> PySide6.QtNetwork.QHttpHeaders: ...
    @staticmethod
    def fromMultiHash(headers: typing.Dict[typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray], typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray]], /) -> PySide6.QtNetwork.QHttpHeaders: ...
    @staticmethod
    def fromMultiMap(headers: typing.Dict[typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray], typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray]], /) -> PySide6.QtNetwork.QHttpHeaders: ...
    @typing.overload
    ...
    @typing.overload
    def value(self, name: PySide6.QtNetwork.QHttpHeaders.WellKnownHeader, /, defaultValue: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> PySide6.QtCore.QByteArray: ...
    @typing.overload
    def value(self, name: str, /, defaultValue: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> PySide6.QtCore.QByteArray: ...
...
class QHttpMultiPart(PySide6.QtCore.QObject):
    ...
    def setBoundary(self, boundary: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QHttpPart(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QHttpPart: ...
    def __eq__(self, other: PySide6.QtNetwork.QHttpPart, /) -> bool: ...
    def __ne__(self, other: PySide6.QtNetwork.QHttpPart, /) -> bool: ...
    def setBody(self, body: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    ...
    def setRawHeader(self, headerName: PySide6.QtCore.QByteArray | bytes | bytearray | str, headerValue: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QIPv6Address(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QIPv6Address: ...
...
class QNetworkAccessManager(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def get(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNetwork.QNetworkReply: ...
    ...
    @typing.overload
    def post(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNetwork.QNetworkReply: ...
    def proxy(self, /) -> PySide6.QtNetwork.QNetworkProxy: ...
    ...
    @typing.overload
    def put(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNetwork.QNetworkReply: ...
    def redirectPolicy(self, /) -> PySide6.QtNetwork.QNetworkRequest.RedirectPolicy: ...
    @typing.overload
    def sendCustomRequest(self, request: PySide6.QtNetwork.QNetworkRequest, verb: PySide6.QtCore.QByteArray | bytes | bytearray | str, multiPart: PySide6.QtNetwork.QHttpMultiPart, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def sendCustomRequest(self, request: PySide6.QtNetwork.QNetworkRequest, verb: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, data: PySide6.QtCore.QIODevice | None = ...) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def sendCustomRequest(self, request: PySide6.QtNetwork.QNetworkRequest, verb: PySide6.QtCore.QByteArray | bytes | bytearray | str, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNetwork.QNetworkReply: ...
...
class QNetworkAddressEntry(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QNetworkAddressEntry: ...
...
class QNetworkCacheMetaData(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QNetworkCacheMetaData: ...
    ...
    def setRawHeaders(self, headers: collections.abc.Sequence[typing.Tuple[typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray], typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray]]], /) -> None: ...
...
class QNetworkCookie(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, /, name: PySide6.QtCore.QByteArray | bytes | bytearray | str = ..., value: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> None: ...

    def __copy__(self, /) -> PySide6.QtNetwork.QNetworkCookie: ...
    ...
    @staticmethod
    def parseCookies(cookieString: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> typing.List[PySide6.QtNetwork.QNetworkCookie]: ...
    def path(self, /) -> str: ...
    ...
    def setName(self, cookieName: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    ...
    def setValue(self, value: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QNetworkDatagram(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, destinationAddress: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress = ..., port: int | None = ...) -> None: ...

    def __copy__(self, /) -> PySide6.QtNetwork.QNetworkDatagram: ...
    def clear(self, /) -> None: ...
    ...
    def isNull(self, /) -> bool: ...
    def isValid(self, /) -> bool: ...
    def makeReply(self, payload: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNetwork.QNetworkDatagram: ...
    ...
    def swap(self, other: PySide6.QtNetwork.QNetworkDatagram | PySide6.QtCore.QByteArray | bytes | bytearray, /) -> None: ...
...
class QNetworkInterface(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QNetworkInterface: ...
    def __repr__(self, /) -> str: ...
...
class QNetworkProxy(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QNetworkProxy: ...
    ...
    def hasRawHeader(self, headerName: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> bool: ...
    ...
    def password(self, /) -> str: ...
    def port(self, /) -> int: ...
    def rawHeader(self, headerName: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtCore.QByteArray: ...
    ...
    def setRawHeader(self, headerName: PySide6.QtCore.QByteArray | bytes | bytearray | str, value: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QNetworkProxyQuery(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QNetworkProxyQuery: ...
...
class QNetworkReply(PySide6.QtCore.QIODevice):
    ...
    def setUrl(self, url: PySide6.QtCore.QUrl | str, /) -> None: ...
    def setWellKnownHeader(self, name: PySide6.QtNetwork.QHttpHeaders.WellKnownHeader, value: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    def sslConfiguration(self, /) -> PySide6.QtNetwork.QSslConfiguration: ...
...
class QNetworkRequest(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QNetworkRequest: ...
...
class QNetworkRequestFactory(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QNetworkRequestFactory: ...
    @typing.overload
    ...
    def setBearerToken(self, token: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QOcspResponse(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QOcspResponse: ...
...
class QPasswordDigestor(shiboken6.Shiboken.Object):
    @staticmethod
    def deriveKeyPbkdf1(algorithm: PySide6.QtCore.QCryptographicHash.Algorithm, password: PySide6.QtCore.QByteArray | bytes | bytearray | str, salt: PySide6.QtCore.QByteArray | bytes | bytearray | str, iterations: int, dkLen: int, /) -> PySide6.QtCore.QByteArray: ...
    @staticmethod
    def deriveKeyPbkdf2(algorithm: PySide6.QtCore.QCryptographicHash.Algorithm, password: PySide6.QtCore.QByteArray | bytes | bytearray | str, salt: PySide6.QtCore.QByteArray | bytes | bytearray | str, iterations: int, dkLen: int, /) -> PySide6.QtCore.QByteArray: ...
...
class QRestAccessManager(PySide6.QtCore.QObject):
    ...
    def get(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def get(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, context: PySide6.QtCore.QObject, slot: collections.abc.Callable[..., typing.Any], /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def head(self, request: PySide6.QtNetwork.QNetworkRequest, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    ...
    @typing.overload
    def patch(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def patch(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, context: PySide6.QtCore.QObject, slot: collections.abc.Callable[..., typing.Any], /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def post(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QIODevice, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    ...
    def post(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def post(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, context: PySide6.QtCore.QObject, slot: collections.abc.Callable[..., typing.Any], /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def put(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QIODevice, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    ...
    def put(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def put(self, request: PySide6.QtNetwork.QNetworkRequest, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, context: PySide6.QtCore.QObject, slot: collections.abc.Callable[..., typing.Any], /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def sendCustomRequest(self, request: PySide6.QtNetwork.QNetworkRequest, method: PySide6.QtCore.QByteArray | bytes | bytearray | str, data: PySide6.QtCore.QIODevice, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def sendCustomRequest(self, request: PySide6.QtNetwork.QNetworkRequest, method: PySide6.QtCore.QByteArray | bytes | bytearray | str, data: PySide6.QtCore.QIODevice, context: PySide6.QtCore.QObject, slot: collections.abc.Callable[..., typing.Any], /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def sendCustomRequest(self, request: PySide6.QtNetwork.QNetworkRequest, method: PySide6.QtCore.QByteArray | bytes | bytearray | str, data: PySide6.QtNetwork.QHttpMultiPart, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def sendCustomRequest(self, request: PySide6.QtNetwork.QNetworkRequest, method: PySide6.QtCore.QByteArray | bytes | bytearray | str, data: PySide6.QtNetwork.QHttpMultiPart, context: PySide6.QtCore.QObject, slot: collections.abc.Callable[..., typing.Any], /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def sendCustomRequest(self, request: PySide6.QtNetwork.QNetworkRequest, method: PySide6.QtCore.QByteArray | bytes | bytearray | str, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNetwork.QNetworkReply: ...
    @typing.overload
    def sendCustomRequest(self, request: PySide6.QtNetwork.QNetworkRequest, method: PySide6.QtCore.QByteArray | bytes | bytearray | str, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, context: PySide6.QtCore.QObject, slot: collections.abc.Callable[..., typing.Any], /) -> PySide6.QtNetwork.QNetworkReply: ...
...
class QSslCertificate(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, /, data: PySide6.QtCore.QByteArray | bytes | bytearray | str = ..., format: PySide6.QtNetwork.QSsl.EncodingFormat = ...) -> None: ...

    def __copy__(self, /) -> PySide6.QtNetwork.QSslCertificate: ...
    ...
    @staticmethod
    def fromData(data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, format: PySide6.QtNetwork.QSsl.EncodingFormat = ...) -> typing.List[PySide6.QtNetwork.QSslCertificate]: ...
    @staticmethod
    ...
    def handle(self, /) -> int: ...
    @staticmethod
    def importPkcs12(device: PySide6.QtCore.QIODevice, key: PySide6.QtNetwork.QSslKey | int, cert: PySide6.QtNetwork.QSslCertificate | PySide6.QtCore.QIODevice, /, caCertificates: collections.abc.Sequence[PySide6.QtNetwork.QSslCertificate] | None = ..., passPhrase: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> bool: ...
    ...
    @typing.overload
    def issuerInfo(self, attribute: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> typing.List[str]: ...
    ...
    @typing.overload
    def subjectInfo(self, attribute: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> typing.List[str]: ...
...
class QSslCertificateExtension(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QSslCertificateExtension: ...
...
class QSslCipher(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QSslCipher: ...
...
class QSslConfiguration(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QSslConfiguration: ...
    ...
    def setAllowedNextProtocols(self, protocols: collections.abc.Sequence[typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray]], /) -> None: ...
    def setBackendConfiguration(self, /, backendConfiguration: typing.Dict[typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray], typing.Any] = ...) -> None: ...
    def setBackendConfigurationOption(self, name: PySide6.QtCore.QByteArray | bytes | bytearray | str, value: typing.Any, /) -> None: ...
    ...
    def setPreSharedKeyIdentityHint(self, hint: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    ...
    def setSessionTicket(self, sessionTicket: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QSslDiffieHellmanParameters(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QSslDiffieHellmanParameters: ...
    ...
    @typing.overload
    @staticmethod
    def fromEncoded(encoded: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, format: PySide6.QtNetwork.QSsl.EncodingFormat = ...) -> PySide6.QtNetwork.QSslDiffieHellmanParameters: ...
    def isEmpty(self, /) -> bool: ...
    def isValid(self, /) -> bool: ...
...
class QSslEllipticCurve(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QSslEllipticCurve: ...
...
class QSslError(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QSslError: ...
...
class QSslKey(shiboken6.Shiboken.Object):
    ...
    def __init__(self, /) -> None: ...
    @typing.overload
    def __init__(self, device: PySide6.QtCore.QIODevice, algorithm: PySide6.QtNetwork.QSsl.KeyAlgorithm, /, format: PySide6.QtNetwork.QSsl.EncodingFormat = ..., type: PySide6.QtNetwork.QSsl.KeyType = ..., passPhrase: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> None: ...
    @typing.overload
    def __init__(self, other: PySide6.QtNetwork.QSslKey, /) -> None: ...
    @typing.overload
    def __init__(self, encoded: PySide6.QtCore.QByteArray | bytes | bytearray | str, algorithm: PySide6.QtNetwork.QSsl.KeyAlgorithm, /, format: PySide6.QtNetwork.QSsl.EncodingFormat = ..., type: PySide6.QtNetwork.QSsl.KeyType = ..., passPhrase: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> None: ...
    @typing.overload
    def __init__(self, handle: int, /, type: PySide6.QtNetwork.QSsl.KeyType = ...) -> None: ...

    def __copy__(self, /) -> PySide6.QtNetwork.QSslKey: ...
    ...
    def toDer(self, /, passPhrase: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> PySide6.QtCore.QByteArray: ...
    def toPem(self, /, passPhrase: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> PySide6.QtCore.QByteArray: ...
...
class QSslPreSharedKeyAuthenticator(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNetwork.QSslPreSharedKeyAuthenticator: ...
    ...
    def setIdentity(self, identity: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    def setPreSharedKey(self, preSharedKey: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QSslSocket(PySide6.QtNetwork.QTcpSocket):
    ...
    @typing.overload
    def setPrivateKey(self, fileName: str, /, algorithm: PySide6.QtNetwork.QSsl.KeyAlgorithm = ..., format: PySide6.QtNetwork.QSsl.EncodingFormat = ..., passPhrase: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> None: ...
    @typing.overload
    def setPrivateKey(self, key: PySide6.QtNetwork.QSslKey | int, /) -> None: ...
    def setProtocol(self, protocol: PySide6.QtNetwork.QSsl.SslProtocol, /) -> None: ...
    def setReadBufferSize(self, size: int, /) -> None: ...
...
class QUdpSocket(PySide6.QtNetwork.QAbstractSocket):
    ...
    @typing.overload
    def writeDatagram(self, datagram: PySide6.QtNetwork.QNetworkDatagram | PySide6.QtCore.QByteArray | bytes | bytearray, /) -> int: ...
    @typing.overload
    def writeDatagram(self, datagram: PySide6.QtCore.QByteArray | bytes | bytearray | str, host: PySide6.QtNetwork.QHostAddress | PySide6.QtNetwork.QHostAddress.SpecialAddress, port: int, /) -> int: ...
