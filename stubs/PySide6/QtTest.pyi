...
class QSignalSpy(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, obj: PySide6.QtCore.QObject, aSignal: str, /) -> None: ...
    @typing.overload
...
class QTest(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def compare_ptr_helper(t1: PySide6.QtCore.QObject, t2: PySide6.QtCore.QObject, actual: str, expected: str, file: str, line: int, /) -> bool: ...
    @typing.overload
    @staticmethod
    def compare_ptr_helper(t1: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, t2: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, actual: str, expected: str, file: str, line: int, /) -> bool: ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def failOnWarning(message: str, /) -> None: ...
    @typing.overload
    @staticmethod
    def failOnWarning(messagePattern: PySide6.QtCore.QRegularExpression | str, /) -> None: ...
    @staticmethod
    def formatString(prefix: str, suffix: str, numArguments: int, /) -> str: ...
    @typing.overload
    @staticmethod
    def ignoreMessage(type: PySide6.QtCore.QtMsgType, message: str, /) -> None: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def qCaught(expected: str, what: str, file: str, line: int, /) -> None: ...
    @typing.overload
    @staticmethod
    def qCaught(expected: str, file: str, line: int, /) -> None: ...
    @staticmethod
    def qCleanup() -> None: ...
    @staticmethod
    def qElementData(elementName: str, metaTypeId: int, /) -> shiboken6.Shiboken.VoidPtr | None: ...
    @staticmethod
    def qExpectFail(dataIndex: str, comment: str, mode: PySide6.QtTest.QTest.TestFailMode, file: str, line: int, /) -> bool: ...
    @staticmethod
    def qFindTestData(basepath: str, /, file: str | None = ..., line: int | None = ..., builddir: str | None = ..., sourcedir: str | None = ...) -> str: ...
    @staticmethod
    def qGlobalData(tagName: str, typeId: int, /) -> shiboken6.Shiboken.VoidPtr | None: ...
    @staticmethod
    def qRun() -> int: ...
    @staticmethod
    ...
    @staticmethod
    def setMainSourcePath(file: str, /, builddir: str | None = ...) -> None: ...
    @staticmethod
