...
class QTest(Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def compare_ptr_helper(t1: shiboken6.Shiboken.VoidPtr | Shiboken.Object, t2: shiboken6.Shiboken.VoidPtr | Shiboken.Object, actual: bytes | bytearray | memoryview, expected: bytes | bytearray | memoryview, file: bytes | bytearray | memoryview, line: int, /) -> bool: ...
    @staticmethod
