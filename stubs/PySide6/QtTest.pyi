...
class QTest(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def compare_ptr_helper(t1: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, t2: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, actual: bytes | bytearray | memoryview, expected: bytes | bytearray | memoryview, file: bytes | bytearray | memoryview, line: int, /) -> bool: ...
    @staticmethod
    ...
    def qCleanup() -> None: ...
    @staticmethod
    def qElementData(elementName: bytes | bytearray | memoryview, metaTypeId: int, /) -> shiboken6.Shiboken.VoidPtr | None: ...
    @staticmethod
    ...
    @staticmethod
    def qGlobalData(tagName: bytes | bytearray | memoryview, typeId: int, /) -> shiboken6.Shiboken.VoidPtr | None: ...
    @staticmethod
    def qRun() -> int: ...
    @staticmethod
