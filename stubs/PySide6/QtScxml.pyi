...
class QScxmlError(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtScxml.QScxmlError: ...
    def column(self, /) -> int: ...
...
class QScxmlEvent(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtScxml.QScxmlEvent: ...
    def clear(self, /) -> None: ...
...
class QScxmlExecutableContent(shiboken6.Shiboken.Object):
    class AssignmentInfo(shiboken6.Shiboken.Object):
        ...
        @context.setter
        def context(self, context: int) -> None: ...
        @property
        def dest(self) -> int: ...
        @dest.setter
        ...
        def __copy__(self, /) -> PySide6.QtScxml.QScxmlExecutableContent.AssignmentInfo: ...
    ...
    class EvaluatorInfo(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtScxml.QScxmlExecutableContent.EvaluatorInfo: ...

    class ForeachInfo(shiboken6.Shiboken.Object):
        @property
        def array(self) -> int: ...
        @array.setter
        def array(self, array: int) -> None: ...
        @property
        def context(self) -> int: ...
        @context.setter
        def context(self, context: int) -> None: ...
        ...
        def __copy__(self, /) -> PySide6.QtScxml.QScxmlExecutableContent.ForeachInfo: ...

    class InvokeInfo(shiboken6.Shiboken.Object):
        @property
        def autoforward(self) -> bool: ...
        @autoforward.setter
        def autoforward(self, autoforward: bool) -> None: ...
        @property
        def context(self) -> int: ...
        @context.setter
        def context(self, context: int) -> None: ...
        ...
        @finalize.setter
        def finalize(self, finalize: int) -> None: ...
        @property
        def id(self) -> int: ...
        @id.setter
        ...
        def prefix(self) -> int: ...
        @prefix.setter
        def prefix(self, prefix: int) -> None: ...
        ...
        def __copy__(self, /) -> PySide6.QtScxml.QScxmlExecutableContent.InvokeInfo: ...
    ...
    class ParameterInfo(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtScxml.QScxmlExecutableContent.ParameterInfo: ...
...
class QScxmlStateMachine(PySide6.QtCore.QObject):
    ...
    def connectToEvent(self, scxmlEventSpec: str, receiver: PySide6.QtCore.QObject, method: str, /, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...
    def connectToState(self, scxmlStateName: str, receiver: PySide6.QtCore.QObject, method: str, /, type: PySide6.QtCore.Qt.ConnectionType = ...) -> PySide6.QtCore.QMetaObject.Connection: ...
