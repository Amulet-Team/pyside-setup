...
class QSensor(PySide6.QtCore.QObject):
    ...
    @staticmethod
    def defaultSensorForType(type: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtCore.QByteArray: ...
    ...
    @staticmethod
    def sensorsForType(type: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> typing.List[PySide6.QtCore.QByteArray]: ...
    ...
    def setIdentifier(self, identifier: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QSensorManager(shiboken6.Shiboken.Object):
    ...
    @staticmethod
    def isBackendRegistered(type: PySide6.QtCore.QByteArray | bytes | bytearray | str, identifier: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> bool: ...
    @staticmethod
    def registerBackend(type: PySide6.QtCore.QByteArray | bytes | bytearray | str, identifier: PySide6.QtCore.QByteArray | bytes | bytearray | str, factory: PySide6.QtSensors.QSensorBackendFactory, /) -> None: ...
    @staticmethod
    def setDefaultBackend(type: PySide6.QtCore.QByteArray | bytes | bytearray | str, identifier: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    @staticmethod
    def unregisterBackend(type: PySide6.QtCore.QByteArray | bytes | bytearray | str, identifier: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class qoutputrange(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtSensors.qoutputrange: ...
