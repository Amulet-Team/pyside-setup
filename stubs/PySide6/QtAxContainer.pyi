...
class QAxBase(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def dynamicCall(self, name: str, vars: collections.abc.Sequence[typing.Any], /) -> typing.Any: ...
    @typing.overload
    ...
    @typing.overload
    def querySubObject(self, name: str, vars: collections.abc.Sequence[typing.Any], /) -> PySide6.QtAxContainer.QAxObject: ...
    @typing.overload
    def querySubObject(self, name: str, /, v1: typing.Any = ..., v2: typing.Any = ..., v3: typing.Any = ..., v4: typing.Any = ..., v5: typing.Any = ..., v6: typing.Any = ..., v7: typing.Any = ..., v8: typing.Any = ...) -> PySide6.QtAxContainer.QAxObject: ...
    ...
    def setPropertyWritable(self, arg__1: str, arg__2: bool, /) -> None: ...
...
class QAxWidget(PySide6.QtAxContainer.QAxBaseWidget, PySide6.QtAxContainer.QAxBase):
    ...
    @typing.overload
    def createHostWindow(self, arg__1: bool, arg__2: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> bool: ...
    def doVerb(self, verb: str, /) -> bool: ...
