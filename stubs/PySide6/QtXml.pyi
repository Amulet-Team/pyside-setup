...
class QDomAttr(PySide6.QtXml.QDomNode):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomAttr: ...
    def name(self, /) -> str: ...
...
class QDomCDATASection(PySide6.QtXml.QDomText):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomCDATASection: ...
    def nodeType(self, /) -> PySide6.QtXml.QDomNode.NodeType: ...
...
class QDomCharacterData(PySide6.QtXml.QDomNode):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomCharacterData: ...
...
class QDomComment(PySide6.QtXml.QDomCharacterData):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomComment: ...
    def nodeType(self, /) -> PySide6.QtXml.QDomNode.NodeType: ...
...
class QDomDocument(PySide6.QtXml.QDomNode):
    ...
    class ParseResult(shiboken6.Shiboken.Object):
        ...
        @errorColumn.setter
        def errorColumn(self, errorColumn: int) -> None: ...
        @property
        def errorLine(self) -> int: ...
        @errorLine.setter
        def errorLine(self, errorLine: int) -> None: ...
        @property
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomDocument: ...
    ...
    @typing.overload
    def setContent(self, text: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> typing.Tuple[bool, str, int, int]: ...
    @typing.overload
    def setContent(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, options: PySide6.QtXml.QDomDocument.ParseOption = ...) -> PySide6.QtXml.QDomDocument.ParseResult: ...
    @typing.overload
    def setContent(self, text: PySide6.QtCore.QByteArray | bytes | bytearray | str, namespaceProcessing: bool, /) -> typing.Tuple[bool, str, int, int]: ...
...
class QDomDocumentFragment(PySide6.QtXml.QDomNode):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomDocumentFragment: ...
    def nodeType(self, /) -> PySide6.QtXml.QDomNode.NodeType: ...
...
class QDomDocumentType(PySide6.QtXml.QDomNode):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomDocumentType: ...
...
class QDomElement(PySide6.QtXml.QDomNode):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomElement: ...
...
class QDomEntity(PySide6.QtXml.QDomNode):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomEntity: ...
    def nodeType(self, /) -> PySide6.QtXml.QDomNode.NodeType: ...
...
class QDomEntityReference(PySide6.QtXml.QDomNode):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomEntityReference: ...
    def nodeType(self, /) -> PySide6.QtXml.QDomNode.NodeType: ...
...
class QDomImplementation(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomImplementation: ...
...
class QDomNamedNodeMap(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomNamedNodeMap: ...
...
class QDomNode(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomNode: ...
...
class QDomNodeList(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomNodeList: ...
...
class QDomNotation(PySide6.QtXml.QDomNode):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomNotation: ...
    def nodeType(self, /) -> PySide6.QtXml.QDomNode.NodeType: ...
    def publicId(self, /) -> str: ...
    def systemId(self, /) -> str: ...
...
class QDomProcessingInstruction(PySide6.QtXml.QDomNode):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomProcessingInstruction: ...
    def data(self, /) -> str: ...
    def nodeType(self, /) -> PySide6.QtXml.QDomNode.NodeType: ...
    def setData(self, data: str, /) -> None: ...
    def target(self, /) -> str: ...
...
class QDomText(PySide6.QtXml.QDomCharacterData):
    ...
    def __copy__(self, /) -> PySide6.QtXml.QDomText: ...
    def nodeType(self, /) -> PySide6.QtXml.QDomNode.NodeType: ...
