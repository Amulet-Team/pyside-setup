...
class QCanBusFrame(shiboken6.Shiboken.Object):
    ...
    class TimeStamp(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtSerialBus.QCanBusFrame.TimeStamp: ...
        @staticmethod
    ...
    @typing.overload
    def __init__(self, identifier: int, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...

    def __copy__(self, /) -> PySide6.QtSerialBus.QCanBusFrame: ...
    ...
    def setPayload(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QCanMessageDescription(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtSerialBus.QCanMessageDescription: ...
...
class QCanSignalDescription(shiboken6.Shiboken.Object):
    class MultiplexValueRange(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtSerialBus.QCanSignalDescription.MultiplexValueRange: ...
    ...
    def __copy__(self, /) -> PySide6.QtSerialBus.QCanSignalDescription: ...
    def __repr__(self, /) -> str: ...
    @typing.overload
...
class QCanUniqueIdDescription(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtSerialBus.QCanUniqueIdDescription: ...
    def bitLength(self, /) -> int: ...
...
class QModbusDataUnit(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtSerialBus.QModbusDataUnit: ...
    def isValid(self, /) -> bool: ...
...
class QModbusDeviceIdentification(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtSerialBus.QModbusDeviceIdentification: ...
    ...
    @staticmethod
    def fromByteArray(ba: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtSerialBus.QModbusDeviceIdentification: ...
    def insert(self, objectId: int, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> bool: ...
    def isValid(self, /) -> bool: ...
...
class QModbusPdu(shiboken6.Shiboken.Object):
    ...
    def __init__(self, /) -> None: ...
    @typing.overload
    def __init__(self, code: PySide6.QtSerialBus.QModbusPdu.FunctionCode, newData: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    @typing.overload
    ...
    def isValid(self, /) -> bool: ...
    def setData(self, newData: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
