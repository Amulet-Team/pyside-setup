...
class QAbstractVideoBuffer(shiboken6.Shiboken.Object):
    class MapData(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtMultimedia.QAbstractVideoBuffer.MapData: ...
...
class QAudioBuffer(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, format: PySide6.QtMultimedia.QAudioFormat, /, startTime: int = ...) -> None: ...
    @typing.overload
    def __init__(self, numFrames: int, format: PySide6.QtMultimedia.QAudioFormat, /, startTime: int = ...) -> None: ...

    def __copy__(self, /) -> PySide6.QtMultimedia.QAudioBuffer: ...
...
class QAudioDevice(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtMultimedia.QAudioDevice: ...
...
class QAudioFormat(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtMultimedia.QAudioFormat: ...
...
class QCameraDevice(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtMultimedia.QCameraDevice: ...
...
class QCameraFormat(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtMultimedia.QCameraFormat: ...
...
class QCapturableWindow(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtMultimedia.QCapturableWindow: ...
...
class QMediaFormat(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtMultimedia.QMediaFormat: ...
...
class QMediaMetaData(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtMultimedia.QMediaMetaData: ...
...
class QMediaTimeRange(shiboken6.Shiboken.Object):
    class Interval(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtMultimedia.QMediaTimeRange.Interval: ...
    ...
    def __copy__(self, /) -> PySide6.QtMultimedia.QMediaTimeRange: ...
...
class QPlaybackOptions(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtMultimedia.QPlaybackOptions: ...
...
class QVideoFrame(shiboken6.Shiboken.Object):
    ...
    class PaintOptions(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtMultimedia.QVideoFrame.PaintOptions: ...
    ...
    def __copy__(self, /) -> PySide6.QtMultimedia.QVideoFrame: ...
...
class QVideoFrameFormat(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtMultimedia.QVideoFrameFormat: ...
    ...
    def updateUniformData(self, dst: PySide6.QtCore.QByteArray | bytes | bytearray | str, frame: PySide6.QtMultimedia.QVideoFrame | PySide6.QtMultimedia.QVideoFrameFormat, transform: PySide6.QtGui.QMatrix4x4 | PySide6.QtGui.QTransform, opacity: float, /) -> None: ...
