...
class QBluetoothAddress(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QBluetoothAddress: ...
...
class QBluetoothDeviceInfo(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QBluetoothDeviceInfo: ...
    ...
    def setManufacturerData(self, manufacturerId: int, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> bool: ...
    def setName(self, name: str, /) -> None: ...
    def setRssi(self, signal: int, /) -> None: ...
    def setServiceData(self, serviceId: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> bool: ...
...
class QBluetoothHostInfo(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QBluetoothHostInfo: ...
...
class QBluetoothServiceInfo(shiboken6.Shiboken.Object):
    ...
    class Alternative(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtBluetooth.QBluetoothServiceInfo.Alternative: ...
    ...
    class Sequence(shiboken6.Shiboken.Object):
        ...
        def __add__(self, l: collections.abc.Sequence[typing.Any], /) -> typing.List[typing.Any]: ...
        def __copy__(self, /) -> PySide6.QtBluetooth.QBluetoothServiceInfo.Sequence: ...
        def __iadd__(self, l: collections.abc.Sequence[typing.Any], /) -> typing.List[typing.Any]: ...
        def __lshift__(self, l: collections.abc.Sequence[typing.Any], /) -> typing.List[typing.Any]: ...
        @typing.overload
        def append(self, l: collections.abc.Sequence[typing.Any], /) -> None: ...
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QBluetoothServiceInfo: ...
    def __repr__(self, /) -> str: ...
...
class QBluetoothUuid(PySide6.QtCore.QUuid):
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QBluetoothUuid: ...
...
class QLowEnergyAdvertisingData(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QLowEnergyAdvertisingData: ...
    ...
    def setManufacturerData(self, id: int, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    def setRawData(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QLowEnergyAdvertisingParameters(shiboken6.Shiboken.Object):
    ...
    class AddressInfo(shiboken6.Shiboken.Object):
        ...
        def address(self) -> PySide6.QtBluetooth.QBluetoothAddress: ...
        @address.setter
        def address(self, address: PySide6.QtBluetooth.QBluetoothAddress) -> None: ...
        @property
        def type(self) -> PySide6.QtBluetooth.QLowEnergyController.RemoteAddressType: ...
        @type.setter
        def type(self, type: PySide6.QtBluetooth.QLowEnergyController.RemoteAddressType) -> None: ...
        ...
        def __copy__(self, /) -> PySide6.QtBluetooth.QLowEnergyAdvertisingParameters.AddressInfo: ...
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QLowEnergyAdvertisingParameters: ...
...
class QLowEnergyCharacteristic(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QLowEnergyCharacteristic: ...
...
class QLowEnergyCharacteristicData(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QLowEnergyCharacteristicData: ...
...
class QLowEnergyConnectionParameters(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QLowEnergyConnectionParameters: ...
...
class QLowEnergyDescriptor(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QLowEnergyDescriptor: ...
...
class QLowEnergyDescriptorData(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, uuid: PySide6.QtBluetooth.QBluetoothUuid | PySide6.QtBluetooth.QBluetoothUuid.CharacteristicType | PySide6.QtBluetooth.QBluetoothUuid.DescriptorType | PySide6.QtBluetooth.QBluetoothUuid.ProtocolUuid | PySide6.QtBluetooth.QBluetoothUuid.ServiceClassUuid | PySide6.QtCore.QUuid, value: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...

    def __copy__(self, /) -> PySide6.QtBluetooth.QLowEnergyDescriptorData: ...
...
class QLowEnergyService(PySide6.QtCore.QObject):
    ...
    def writeCharacteristic(self, characteristic: PySide6.QtBluetooth.QLowEnergyCharacteristic, newValue: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, mode: PySide6.QtBluetooth.QLowEnergyService.WriteMode = ...) -> None: ...
    def writeDescriptor(self, descriptor: PySide6.QtBluetooth.QLowEnergyDescriptor, newValue: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QLowEnergyServiceData(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtBluetooth.QLowEnergyServiceData: ...
