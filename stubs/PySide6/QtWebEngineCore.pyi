...
class QWebEngineCertificateError(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineCertificateError: ...
...
class QWebEngineClientCertificateSelection(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineClientCertificateSelection: ...
...
class QWebEngineCookieStore(PySide6.QtCore.QObject):
    ...
    class FilterRequest(shiboken6.Shiboken.Object):
        @property
        def _reservedFlag(self) -> bool: ...
        @_reservedFlag.setter
        def _reservedFlag(self, _reservedFlag: bool) -> None: ...
        @property
        def _reservedType(self) -> int: ...
        @_reservedType.setter
        def _reservedType(self, _reservedType: int) -> None: ...
        @property
        def firstPartyUrl(self) -> PySide6.QtCore.QUrl: ...
        @firstPartyUrl.setter
        def firstPartyUrl(self, firstPartyUrl: PySide6.QtCore.QUrl) -> None: ...
        @property
        def origin(self) -> PySide6.QtCore.QUrl: ...
        @origin.setter
        def origin(self, origin: PySide6.QtCore.QUrl) -> None: ...
        @property
        def thirdParty(self) -> bool: ...
        @thirdParty.setter
        def thirdParty(self, thirdParty: bool) -> None: ...
        ...
        def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineCookieStore.FilterRequest: ...
...
class QWebEngineDesktopMediaRequest(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineDesktopMediaRequest: ...
...
class QWebEngineExtensionInfo(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineExtensionInfo: ...
...
class QWebEngineFileSystemAccessRequest(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineFileSystemAccessRequest: ...
...
class QWebEngineFindTextResult(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineFindTextResult: ...
...
class QWebEngineFrame(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineFrame: ...
...
class QWebEngineFullScreenRequest(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineFullScreenRequest: ...
    def accept(self, /) -> None: ...
    def origin(self, /) -> PySide6.QtCore.QUrl: ...
    def reject(self, /) -> None: ...
...
class QWebEngineGlobalSettings(shiboken6.Shiboken.Object):
    class DnsMode(shiboken6.Shiboken.Object):
        @property
        def secureMode(self) -> PySide6.QtWebEngineCore.QWebEngineGlobalSettings.SecureDnsMode: ...
        @secureMode.setter
        def secureMode(self, secureMode: PySide6.QtWebEngineCore.QWebEngineGlobalSettings.SecureDnsMode) -> None: ...
        @property
        def serverTemplates(self) -> typing.List[str]: ...
        @serverTemplates.setter
        def serverTemplates(self, serverTemplates: typing.List[str]) -> None: ...
        ...
        def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineGlobalSettings.DnsMode: ...
...
class QWebEngineHistoryItem(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineHistoryItem: ...
...
class QWebEngineHttpRequest(shiboken6.Shiboken.Object):
    ...
    def hasHeader(self, headerName: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> bool: ...
    def header(self, headerName: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtCore.QByteArray: ...
    ...
    def setHeader(self, headerName: PySide6.QtCore.QByteArray | bytes | bytearray | str, value: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    def setMethod(self, method: PySide6.QtWebEngineCore.QWebEngineHttpRequest.Method, /) -> None: ...
    def setPostData(self, postData: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    def setUrl(self, url: PySide6.QtCore.QUrl | str, /) -> None: ...
    def swap(self, other: PySide6.QtWebEngineCore.QWebEngineHttpRequest, /) -> None: ...
    def unsetHeader(self, headerName: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    def url(self, /) -> PySide6.QtCore.QUrl: ...
...
class QWebEngineLoadingInfo(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineLoadingInfo: ...
...
class QWebEnginePage(PySide6.QtCore.QObject):
    ...
    def setContent(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, mimeType: str = ..., baseUrl: PySide6.QtCore.QUrl | str = ...) -> None: ...
...
class QWebEnginePermission(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEnginePermission: ...
...
class QWebEngineRegisterProtocolHandlerRequest(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineRegisterProtocolHandlerRequest: ...
...
class QWebEngineScript(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineScript: ...
...
class QWebEngineUrlRequestInfo(shiboken6.Shiboken.Object):
    ...
    def setHttpHeader(self, name: PySide6.QtCore.QByteArray | bytes | bytearray | str, value: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QWebEngineUrlRequestJob(PySide6.QtCore.QObject):
    ...
    def initiator(self, /) -> PySide6.QtCore.QUrl: ...
    def redirect(self, url: PySide6.QtCore.QUrl | str, /) -> None: ...
    def reply(self, contentType: PySide6.QtCore.QByteArray | bytes | bytearray | str, device: PySide6.QtCore.QIODevice, /) -> None: ...
    def requestBody(self, /) -> PySide6.QtCore.QIODevice: ...
    def requestHeaders(self, /) -> typing.Dict[PySide6.QtCore.QByteArray, PySide6.QtCore.QByteArray]: ...
    def requestMethod(self, /) -> PySide6.QtCore.QByteArray: ...
    def requestUrl(self, /) -> PySide6.QtCore.QUrl: ...
    def setAdditionalResponseHeaders(self, additionalResponseHeaders: typing.Dict[typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray], typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray]], /) -> None: ...
...
class QWebEngineUrlScheme(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineUrlScheme: ...
    ...
    @staticmethod
    def schemeByName(name: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtWebEngineCore.QWebEngineUrlScheme: ...
    ...
    def setName(self, newValue: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QWebEngineWebAuthPinRequest(shiboken6.Shiboken.Object):
    @property
    def error(self) -> PySide6.QtWebEngineCore.QWebEngineWebAuthUxRequest.PinEntryError: ...
    @error.setter
    def error(self, error: PySide6.QtWebEngineCore.QWebEngineWebAuthUxRequest.PinEntryError) -> None: ...
    @property
    def minPinLength(self) -> int: ...
    @minPinLength.setter
    def minPinLength(self, minPinLength: int) -> None: ...
    @property
    def reason(self) -> PySide6.QtWebEngineCore.QWebEngineWebAuthUxRequest.PinEntryReason: ...
    @reason.setter
    def reason(self, reason: PySide6.QtWebEngineCore.QWebEngineWebAuthUxRequest.PinEntryReason) -> None: ...
    @property
    def remainingAttempts(self) -> int: ...
    @remainingAttempts.setter
    def remainingAttempts(self, remainingAttempts: int) -> None: ...
    ...
    def __copy__(self, /) -> PySide6.QtWebEngineCore.QWebEngineWebAuthPinRequest: ...
