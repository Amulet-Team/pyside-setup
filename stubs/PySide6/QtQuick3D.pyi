...
class QQuick3DGeometry(PySide6.QtQuick3D.QQuick3DObject):
    ...
    class Attribute(shiboken6.Shiboken.Object):
        ...
        def componentType(self, componentType: int) -> None: ...
        @property
        def offset(self) -> int: ...
        @offset.setter
    ...
    class TargetAttribute(shiboken6.Shiboken.Object):
        ...
        @attr.setter
        def attr(self, attr: PySide6.QtQuick3D.QQuick3DGeometry.Attribute) -> None: ...
        @property
        def stride(self) -> int: ...
        @stride.setter
        ...
        @targetId.setter
        def targetId(self, targetId: int) -> None: ...
    ...
    @typing.overload
    def setIndexData(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    @typing.overload
    def setIndexData(self, offset: int, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    def setPrimitiveType(self, type: PySide6.QtQuick3D.QQuick3DGeometry.PrimitiveType, /) -> None: ...
    def setStride(self, stride: int, /) -> None: ...
    @typing.overload
    def setTargetData(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    @typing.overload
    def setTargetData(self, offset: int, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    @typing.overload
    def setVertexData(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    @typing.overload
    def setVertexData(self, offset: int, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    def stride(self, /) -> int: ...
...
class QQuick3DInstancing(PySide6.QtQuick3D.QQuick3DObject):
    ...
    class InstanceTableEntry(shiboken6.Shiboken.Object):
        ...
        @color.setter
        def color(self, color: PySide6.QtGui.QVector4D) -> None: ...
        @property
        def instanceData(self) -> PySide6.QtGui.QVector4D: ...
        @instanceData.setter
        def instanceData(self, instanceData: PySide6.QtGui.QVector4D) -> None: ...
        @property
        def row0(self) -> PySide6.QtGui.QVector4D: ...
        @row0.setter
        def row0(self, row0: PySide6.QtGui.QVector4D) -> None: ...
        @property
        def row1(self) -> PySide6.QtGui.QVector4D: ...
        @row1.setter
        def row1(self, row1: PySide6.QtGui.QVector4D) -> None: ...
        @property
        def row2(self) -> PySide6.QtGui.QVector4D: ...
        @row2.setter
        def row2(self, row2: PySide6.QtGui.QVector4D) -> None: ...
        ...
        def __copy__(self, /) -> PySide6.QtQuick3D.QQuick3DInstancing.InstanceTableEntry: ...
...
class QQuick3DTextureData(PySide6.QtQuick3D.QQuick3DObject):
    ...
    def setTextureData(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
