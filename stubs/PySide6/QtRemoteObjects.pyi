...
class QRemoteObjectReplica(PySide6.QtCore.QObject):
    ...
    def persistProperties(self, repName: str, repSig: PySide6.QtCore.QByteArray | bytes | bytearray | str, props: collections.abc.Sequence[typing.Any], /) -> None: ...
    def propAsVariant(self, i: int, /) -> typing.Any: ...
    def retrieveProperties(self, repName: str, repSig: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> typing.List[typing.Any]: ...
...
class QRemoteObjectSourceLocationInfo(Shiboken.Object):
    ...
    def hostUrl(self) -> PySide6.QtCore.QUrl: ...
    @hostUrl.setter
    def hostUrl(self, hostUrl: PySide6.QtCore.QUrl) -> None: ...
    @property
    ...
    def __copy__(self, /) -> PySide6.QtRemoteObjects.QRemoteObjectSourceLocationInfo: ...
...
class QtROIoDeviceBase(PySide6.QtCore.QObject):
    ...
    @typing.overload
    def write(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    @typing.overload
    def write(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, arg__2: int, /) -> None: ...
...
class QtRemoteObjects(Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def copyStoredProperties(mo: PySide6.QtCore.QMetaObject, src: PySide6.QtCore.QDataStream, dst: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    @typing.overload
    @staticmethod
    def copyStoredProperties(mo: PySide6.QtCore.QMetaObject, src: shiboken6.Shiboken.VoidPtr | Shiboken.Object, dst: PySide6.QtCore.QDataStream, /) -> None: ...
    @typing.overload
    @staticmethod
    def copyStoredProperties(mo: PySide6.QtCore.QMetaObject, src: shiboken6.Shiboken.VoidPtr | Shiboken.Object, dst: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
...
class RepFile:
    ...
    @pod.setter
    def pod(self, pod: typing.Any) -> None: ...
    @property
    def replica(self) -> typing.Any: ...
    @replica.setter
    def replica(self, replica: typing.Any) -> None: ...
    @property
    def source(self) -> typing.Any: ...
    @source.setter
    def source(self, source: typing.Any) -> None: ...
