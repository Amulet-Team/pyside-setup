...
class QFutureHttpServerResponse(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtHttpServer.QFutureHttpServerResponse: ...
...
class QHttpServerConfiguration(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtHttpServer.QHttpServerConfiguration: ...
...
class QHttpServerRequest(shiboken6.Shiboken.Object):
    ...
    def value(self, key: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtCore.QByteArray: ...
...
class QHttpServerResponder(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def write(self, data: PySide6.QtCore.QIODevice, mimeType: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def write(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, headers: PySide6.QtNetwork.QHttpHeaders, /, status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...) -> None: ...
    @typing.overload
    def write(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, mimeType: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def writeBeginChunked(self, mimeType: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...) -> None: ...
    def writeChunk(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    @typing.overload
    def writeEndChunked(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    @typing.overload
    def writeEndChunked(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, trailers: PySide6.QtNetwork.QHttpHeaders, /) -> None: ...
...
class QHttpServerResponse(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...) -> None: ...
    @typing.overload
    def __init__(self, mimeType: PySide6.QtCore.QByteArray | bytes | bytearray | str, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, status: PySide6.QtHttpServer.QHttpServerResponder.StatusCode = ...) -> None: ...
...
class QHttpServerWebSocketUpgradeResponse(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def deny(status: int, message: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtHttpServer.QHttpServerWebSocketUpgradeResponse: ...
