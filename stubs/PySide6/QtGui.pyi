...
class QAccessibleInterface(Shiboken.Object):
    ...
    def virtual_hook(self, id: int, data: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
...
class QImage(PySide6.QtGui.QPaintDevice):
    ...
    @typing.overload
    def __init__(self, data: bytes | bytearray | memoryview, width: int, height: int, format: PySide6.QtGui.QImage.Format, /, cleanupFunction: collections.abc.Callable[..., typing.Any] | None = ..., cleanupInfo: shiboken6.Shiboken.VoidPtr | Shiboken.Object | None = ...) -> None: ...
    @typing.overload
    def __init__(self, data: bytes | bytearray | memoryview, width: int, height: int, bytesPerLine: int, format: PySide6.QtGui.QImage.Format, /, cleanupFunction: collections.abc.Callable[..., typing.Any] | None = ..., cleanupInfo: shiboken6.Shiboken.VoidPtr | Shiboken.Object | None = ...) -> None: ...
    @typing.overload
...
class QOpenGLExtraFunctions(PySide6.QtGui.QOpenGLFunctions):
    ...
    def glCompressedTexImage3D(self, target: int, level: int, internalformat: int, width: int, height: int, depth: int, border: int, imageSize: int, data: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    def glCompressedTexSubImage3D(self, target: int, level: int, xoffset: int, yoffset: int, zoffset: int, width: int, height: int, depth: int, format: int, imageSize: int, data: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    ...
    def glDrawArraysIndirect(self, mode: int, indirect: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    ...
    def glDrawElementsBaseVertex(self, mode: int, count: int, type: int, indices: shiboken6.Shiboken.VoidPtr | Shiboken.Object, basevertex: int, /) -> None: ...
    def glDrawElementsIndirect(self, mode: int, type: int, indirect: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    def glDrawElementsInstanced(self, mode: int, count: int, type: int, indices: shiboken6.Shiboken.VoidPtr | Shiboken.Object, instancecount: int, /) -> None: ...
    def glDrawElementsInstancedBaseVertex(self, mode: int, count: int, type: int, indices: shiboken6.Shiboken.VoidPtr | Shiboken.Object, instancecount: int, basevertex: int, /) -> None: ...
    def glDrawRangeElements(self, mode: int, start: int, end: int, count: int, type: int, indices: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    def glDrawRangeElementsBaseVertex(self, mode: int, start: int, end: int, count: int, type: int, indices: shiboken6.Shiboken.VoidPtr | Shiboken.Object, basevertex: int, /) -> None: ...
    ...
    def glObjectPtrLabel(self, ptr: shiboken6.Shiboken.VoidPtr | Shiboken.Object, length: int, label: str, /) -> None: ...
    ...
    def glProgramBinary(self, program: int, binaryFormat: int, binary: shiboken6.Shiboken.VoidPtr | Shiboken.Object, length: int, /) -> None: ...
    ...
    def glReadnPixels(self, x: int, y: int, width: int, height: int, format: int, type: int, bufSize: int, data: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    ...
    def glTexImage3D(self, target: int, level: int, internalformat: int, width: int, height: int, depth: int, border: int, format: int, type: int, pixels: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    ...
    def glTexSubImage3D(self, target: int, level: int, xoffset: int, yoffset: int, zoffset: int, width: int, height: int, depth: int, format: int, type: int, pixels: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    ...
    def glVertexAttribIPointer(self, index: int, size: int, type: int, stride: int, pointer: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
...
class QOpenGLFunctions(Shiboken.Object):
    ...
    def glCompressedTexImage2D(self, target: int, level: int, internalformat: int, width: int, height: int, border: int, imageSize: int, data: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    def glCompressedTexSubImage2D(self, target: int, level: int, xoffset: int, yoffset: int, width: int, height: int, format: int, imageSize: int, data: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    ...
    def glDrawElements(self, mode: int, count: int, type: int, indices: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    ...
    def glReadPixels(self, x: int, y: int, width: int, height: int, format: int, type: int, pixels: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    ...
    def glShaderBinary(self, n: int, shaders: collections.abc.Sequence[int], binaryformat: int, binary: shiboken6.Shiboken.VoidPtr | Shiboken.Object, length: int, /) -> None: ...
    ...
    def glTexImage2D(self, target: int, level: int, internalformat: int, width: int, height: int, border: int, format: int, type: int, pixels: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    ...
    def glTexSubImage2D(self, target: int, level: int, xoffset: int, yoffset: int, width: int, height: int, format: int, type: int, pixels: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    ...
    def glVertexAttribPointer(self, indx: int, size: int, type: int, normalized: int, stride: int, ptr: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
...
class QRhi(Shiboken.Object):
    ...
    def removeCleanupCallback(self, key: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
...
class QRhiBuffer(PySide6.QtGui.QRhiResource):
    ...
    def fullDynamicBufferUpdateForCurrentFrame(self, data: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /, size: int | None = ...) -> None: ...
...
class QRhiResourceUpdateBatch(Shiboken.Object):
    ...
    @typing.overload
    def updateDynamicBuffer(self, buf: PySide6.QtGui.QRhiBuffer, offset: int, size: int, data: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    @typing.overload
    def uploadStaticBuffer(self, buf: PySide6.QtGui.QRhiBuffer, data: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def uploadStaticBuffer(self, buf: PySide6.QtGui.QRhiBuffer, offset: int, size: int, data: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> None: ...
    @typing.overload
...
class QRhiTextureSubresourceUploadDescription(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, data: shiboken6.Shiboken.VoidPtr | Shiboken.Object, size: int, /) -> None: ...
    @typing.overload
...
class QWindow(PySide6.QtCore.QObject, PySide6.QtGui.QSurface):
    ...
    def nativeEvent(self, eventType: PySide6.QtCore.QByteArray | bytes | bytearray | str, message: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> object: ...
    def opacity(self, /) -> float: ...
