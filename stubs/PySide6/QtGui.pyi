...
class QOpenGLExtraFunctions(PySide6.QtGui.QOpenGLFunctions):
    ...
    def glObjectPtrLabel(self, ptr: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, length: int, label: bytes | bytearray | memoryview, /) -> None: ...
...
class QWindow(PySide6.QtCore.QObject, PySide6.QtGui.QSurface):
    ...
    def nativeEvent(self, eventType: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, message: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, /) -> object: ...
    def opacity(self, /) -> float: ...
