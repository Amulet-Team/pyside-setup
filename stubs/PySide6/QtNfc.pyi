...
class QNdefFilter(shiboken6.Shiboken.Object):
    class Record(shiboken6.Shiboken.Object):
        ...
        @type.setter
        def type(self, type: PySide6.QtCore.QByteArray) -> None: ...
        @property
        def typeNameFormat(self) -> PySide6.QtNfc.QNdefRecord.TypeNameFormat: ...
        @typeNameFormat.setter
        def typeNameFormat(self, typeNameFormat: PySide6.QtNfc.QNdefRecord.TypeNameFormat) -> None: ...
        ...
        def __copy__(self, /) -> PySide6.QtNfc.QNdefFilter.Record: ...
    ...
    def __copy__(self, /) -> PySide6.QtNfc.QNdefFilter: ...
    @typing.overload
    def appendRecord(self, record: PySide6.QtNfc.QNdefFilter.Record, /) -> bool: ...
    @typing.overload
    def appendRecord(self, typeNameFormat: PySide6.QtNfc.QNdefRecord.TypeNameFormat, type: PySide6.QtCore.QByteArray | bytes | bytearray | str, /, min: int = ..., max: int = ...) -> bool: ...
    def clear(self, /) -> None: ...
...
class QNdefMessage(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtNfc.QNdefMessage: ...
    ...
    @staticmethod
    def fromByteArray(message: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNfc.QNdefMessage: ...
    @staticmethod
...
class QNdefNfcIconRecord(PySide6.QtNfc.QNdefRecord):
    ...
    def __copy__(self, /) -> PySide6.QtNfc.QNdefNfcIconRecord: ...
...
class QNdefNfcSmartPosterRecord(PySide6.QtNfc.QNdefRecord):
    ...
    def __copy__(self, /) -> PySide6.QtNfc.QNdefNfcSmartPosterRecord: ...
    ...
    @typing.overload
    def addIcon(self, type: PySide6.QtCore.QByteArray | bytes | bytearray | str, data: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    @typing.overload
    ...
    def hasIcon(self, /, mimetype: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> bool: ...
    def hasSize(self, /) -> bool: ...
    def hasTitle(self, /, locale: str = ...) -> bool: ...
    def hasTypeInfo(self, /) -> bool: ...
    def icon(self, /, mimetype: PySide6.QtCore.QByteArray | bytes | bytearray | str = ...) -> PySide6.QtCore.QByteArray: ...
    ...
    @typing.overload
    def removeIcon(self, type: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> bool: ...
    @typing.overload
    ...
    def setPayload(self, payload: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QNdefNfcTextRecord(PySide6.QtNfc.QNdefRecord):
    ...
    def __copy__(self, /) -> PySide6.QtNfc.QNdefNfcTextRecord: ...
...
class QNdefNfcUriRecord(PySide6.QtNfc.QNdefRecord):
    ...
    def __copy__(self, /) -> PySide6.QtNfc.QNdefNfcUriRecord: ...
...
class QNdefRecord(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, other: PySide6.QtNfc.QNdefRecord, typeNameFormat: PySide6.QtNfc.QNdefRecord.TypeNameFormat, type: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    @typing.overload
    def __init__(self, typeNameFormat: PySide6.QtNfc.QNdefRecord.TypeNameFormat, type: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...

    def __copy__(self, /) -> PySide6.QtNfc.QNdefRecord: ...
    ...
    def setId(self, id: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    def setPayload(self, payload: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
    def setType(self, type: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> None: ...
...
class QNearFieldTarget(PySide6.QtCore.QObject):
    ...
    class RequestId(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtNfc.QNearFieldTarget.RequestId: ...
    ...
    def sendCommand(self, command: PySide6.QtCore.QByteArray | bytes | bytearray | str, /) -> PySide6.QtNfc.QNearFieldTarget.RequestId: ...
