...
class QBarDataItem(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtGraphs.QBarDataItem: ...
...
class QBarModelMapper(PySide6.QtCore.QObject):
    ...
    def __init__(self, /, parent: PySide6.QtCore.QObject | None = ..., *, series: PySide6.QtCharts.QBarSeries | None = ..., model: PySide6.QtCore.QAbstractItemModel | None = ..., firstBarSetSection: int | None = ..., lastBarSetSection: int | None = ..., first: int | None = ..., count: int | None = ..., orientation: PySide6.QtCore.Qt.Orientation | None = ...) -> None: ...
...
class QGraphsLine(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtGraphs.QGraphsLine: ...
...
class QGraphsThemeDirtyBitField(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtGraphs.QGraphsThemeDirtyBitField: ...
...
class QLegendData(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtGraphs.QLegendData: ...
...
class QScatter3DSeries(PySide6.QtGraphs.QAbstract3DSeries):
    ...
    @typing.overload
    def __init__(self, dataProxy: PySide6.QtGraphs.QScatterDataProxy, /, parent: PySide6.QtCore.QObject | None = ..., *, selectedItem: int | None = ..., itemSize: float | None = ..., dataArray: collections.abc.Sequence[PySide6.QtGraphs.QScatterDataItem] | None = ..., scaleArray: collections.abc.Sequence[PySide6.QtGui.QVector3D] | None = ..., axisX: PySide6.QtDataVisualization.QValue3DAxis | None = ..., axisY: PySide6.QtDataVisualization.QValue3DAxis | None = ..., axisZ: PySide6.QtDataVisualization.QValue3DAxis | None = ...) -> None: ...
    @typing.overload
    def __init__(self, /, parent: PySide6.QtCore.QObject | None = ..., *, dataProxy: PySide6.QtDataVisualization.QScatterDataProxy | None = ..., selectedItem: int | None = ..., itemSize: float | None = ..., dataArray: collections.abc.Sequence[PySide6.QtGraphs.QScatterDataItem] | None = ..., scaleArray: collections.abc.Sequence[PySide6.QtGui.QVector3D] | None = ..., axisX: PySide6.QtDataVisualization.QValue3DAxis | None = ..., axisY: PySide6.QtDataVisualization.QValue3DAxis | None = ..., axisZ: PySide6.QtDataVisualization.QValue3DAxis | None = ...) -> None: ...
...
class QScatterDataItem(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtGraphs.QScatterDataItem: ...
    def position(self, /) -> PySide6.QtGui.QVector3D: ...
    def rotation(self, /) -> PySide6.QtGui.QQuaternion: ...
...
class QSurfaceDataItem(Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtGraphs.QSurfaceDataItem: ...
    def position(self, /) -> PySide6.QtGui.QVector3D: ...
    def setPosition(self, pos: PySide6.QtGui.QVector3D, /) -> None: ...
    def setX(self, value: float, /) -> None: ...
    def setY(self, value: float, /) -> None: ...
