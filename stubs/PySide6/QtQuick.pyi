...
class QSGRenderNode(PySide6.QtQuick.QSGNode):
    ...
    class RenderState(shiboken6.Shiboken.Object):
        ...
        def get(self, state: bytes | bytearray | memoryview, /) -> shiboken6.Shiboken.VoidPtr | None: ...
        def projectionMatrix(self, /) -> PySide6.QtGui.QMatrix4x4: ...
...
class QSGRendererInterface(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def getResource(self, window: PySide6.QtQuick.QQuickWindow, resource: bytes | bytearray | memoryview, /) -> shiboken6.Shiboken.VoidPtr | None: ...
