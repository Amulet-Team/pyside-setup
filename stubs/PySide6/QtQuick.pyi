...
class QQuickGraphicsConfiguration(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtQuick.QQuickGraphicsConfiguration: ...
    ...
    def setDeviceExtensions(self, extensions: collections.abc.Sequence[typing.Union[PySide6.QtCore.QByteArray, bytes, bytearray]], /) -> None: ...
...
class QQuickGraphicsDevice(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtQuick.QQuickGraphicsDevice: ...
    @staticmethod
    def fromAdapter(adapterLuidLow: int, adapterLuidHigh: int, /, featureLevel: int | None = ...) -> PySide6.QtQuick.QQuickGraphicsDevice: ...
    @staticmethod
    def fromDeviceAndContext(device: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, context: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, /) -> PySide6.QtQuick.QQuickGraphicsDevice: ...
    @staticmethod
...
class QQuickItem(PySide6.QtCore.QObject, PySide6.QtQml.QQmlParserStatus):
    ...
    class UpdatePaintNodeData(shiboken6.Shiboken.Object):
        ...
        @property
        def transformNode(self) -> PySide6.QtQuick.QSGTransformNode: ...
        @transformNode.setter
        def transformNode(self, transformNode: PySide6.QtQuick.QSGTransformNode) -> None: ...

        def __init__(self, UpdatePaintNodeData: PySide6.QtQuick.QQuickItem.UpdatePaintNodeData, /) -> None: ...

        def __copy__(self, /) -> PySide6.QtQuick.QQuickItem.UpdatePaintNodeData: ...
    ...
    @typing.overload
    def grabToImage(self, callback: PySide6.QtQml.QJSValue | PySide6.QtQml.QJSValue.SpecialValue | bool | str | float | int, /, targetSize: PySide6.QtCore.QSize = ...) -> bool: ...
...
class QQuickRenderTarget(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtQuick.QQuickRenderTarget: ...
    ...
    @typing.overload
    @staticmethod
    def fromD3D11Texture(texture: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, pixelSize: PySide6.QtCore.QSize, /, sampleCount: int = ...) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromD3D11Texture(texture: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, format: int, pixelSize: PySide6.QtCore.QSize, /, sampleCount: int = ...) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromD3D11Texture(texture: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, format: int, pixelSize: PySide6.QtCore.QSize, sampleCount: int, flags: PySide6.QtQuick.QQuickRenderTarget.Flag, /) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromD3D12Texture(texture: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, resourceState: int, format: int, pixelSize: PySide6.QtCore.QSize, /, sampleCount: int = ...) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromD3D12Texture(texture: shiboken6.Shiboken.VoidPtr | shiboken6.Shiboken.Object, resourceState: int, format: int, viewFormat: int, pixelSize: PySide6.QtCore.QSize, sampleCount: int, arraySize: int, flags: PySide6.QtQuick.QQuickRenderTarget.Flag, /) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @staticmethod
...
class QQuickWindow(PySide6.QtGui.QWindow):
    ...
    class GraphicsStateInfo(shiboken6.Shiboken.Object):
        ...
        @currentFrameSlot.setter
        def currentFrameSlot(self, currentFrameSlot: int) -> None: ...
        @property
        def framesInFlight(self) -> int: ...
        @framesInFlight.setter
        def framesInFlight(self, framesInFlight: int) -> None: ...
        ...
        def __copy__(self, /) -> PySide6.QtQuick.QQuickWindow.GraphicsStateInfo: ...
...
class QSGGeometry(shiboken6.Shiboken.Object):
    ...
    class Attribute(shiboken6.Shiboken.Object):
        ...
        @property
        def attributeType(self) -> PySide6.QtQuick.QSGGeometry.AttributeType: ...
        @attributeType.setter
        def attributeType(self, attributeType: PySide6.QtQuick.QSGGeometry.AttributeType) -> None: ...
        @property
        def isVertexCoordinate(self) -> int: ...
        @isVertexCoordinate.setter
        def isVertexCoordinate(self, isVertexCoordinate: int) -> None: ...
        @property
        ...
        @tupleSize.setter
        def tupleSize(self, tupleSize: int) -> None: ...
        @property
        def type(self) -> int: ...
        @type.setter
        ...
        def __copy__(self, /) -> PySide6.QtQuick.QSGGeometry.Attribute: ...
        @staticmethod
    ...
    class AttributeSet(shiboken6.Shiboken.Object):
        ...
        @attributes.setter
        def attributes(self, attributes: PySide6.QtQuick.QSGGeometry.Attribute) -> None: ...
        @property
        def count(self) -> int: ...
        @count.setter
        ...
        def __copy__(self, /) -> PySide6.QtQuick.QSGGeometry.AttributeSet: ...
    ...
    class ColoredPoint2D(shiboken6.Shiboken.Object):
        ...
        @a.setter
        def a(self, a: typing.Any) -> None: ...
        @property
        def b(self) -> typing.Any: ...
        @b.setter
        def b(self, b: typing.Any) -> None: ...
        @property
        def g(self) -> typing.Any: ...
        @g.setter
        def g(self, g: typing.Any) -> None: ...
        @property
        def r(self) -> typing.Any: ...
        @r.setter
        def r(self, r: typing.Any) -> None: ...
        @property
        def x(self) -> float: ...
        @x.setter
        ...
        def __copy__(self, /) -> PySide6.QtQuick.QSGGeometry.ColoredPoint2D: ...
    ...
    class Point2D(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtQuick.QSGGeometry.Point2D: ...
    ...
    class TexturedPoint2D(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtQuick.QSGGeometry.TexturedPoint2D: ...
    ...
    def indexData(self, /) -> shiboken6.Shiboken.VoidPtr | None: ...
    ...
    def vertexData(self, /) -> shiboken6.Shiboken.VoidPtr | None: ...
...
class QSGMaterialShader(shiboken6.Shiboken.Object):
    ...
    class GraphicsPipelineState(shiboken6.Shiboken.Object):
        ...
        @property
        def blendConstant(self) -> PySide6.QtGui.QColor: ...
        @blendConstant.setter
        def blendConstant(self, blendConstant: PySide6.QtGui.QColor) -> None: ...
        @property
        def blendEnable(self) -> bool: ...
        @blendEnable.setter
        def blendEnable(self, blendEnable: bool) -> None: ...
        @property
        def colorWrite(self) -> PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.ColorMaskComponent: ...
        @colorWrite.setter
        def colorWrite(self, colorWrite: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.ColorMaskComponent) -> None: ...
        @property
        def cullMode(self) -> PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.CullMode: ...
        @cullMode.setter
        def cullMode(self, cullMode: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.CullMode) -> None: ...
        @property
        def dstAlpha(self) -> PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor: ...
        @dstAlpha.setter
        def dstAlpha(self, dstAlpha: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor) -> None: ...
        @property
        def dstColor(self) -> PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor: ...
        @dstColor.setter
        def dstColor(self, dstColor: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor) -> None: ...
        @property
        def opAlpha(self) -> PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendOp: ...
        @opAlpha.setter
        def opAlpha(self, opAlpha: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendOp) -> None: ...
        @property
        def opColor(self) -> PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendOp: ...
        @opColor.setter
        def opColor(self, opColor: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendOp) -> None: ...
        @property
        def polygonMode(self) -> PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.PolygonMode: ...
        @polygonMode.setter
        def polygonMode(self, polygonMode: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.PolygonMode) -> None: ...
        @property
        def separateBlendFactors(self) -> bool: ...
        @separateBlendFactors.setter
        def separateBlendFactors(self, separateBlendFactors: bool) -> None: ...
        @property
        def srcAlpha(self) -> PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor: ...
        @srcAlpha.setter
        def srcAlpha(self, srcAlpha: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor) -> None: ...
        @property
        def srcColor(self) -> PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor: ...
        @srcColor.setter
        def srcColor(self, srcColor: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor) -> None: ...
        ...
        def __copy__(self, /) -> PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState: ...
    ...
    class RenderState(shiboken6.Shiboken.Object):
        ...
        def __copy__(self, /) -> PySide6.QtQuick.QSGMaterialShader.RenderState: ...
        @typing.overload
...
class QSGOpaqueTextureMaterial(PySide6.QtQuick.QSGMaterial):
    ...
    @property
    def m_anisotropy_level(self) -> int: ...
    @m_anisotropy_level.setter
    def m_anisotropy_level(self, m_anisotropy_level: int) -> None: ...
    @property
    def m_filtering(self) -> int: ...
    @m_filtering.setter
    def m_filtering(self, m_filtering: int) -> None: ...
    @property
    def m_horizontal_wrap(self) -> int: ...
    @m_horizontal_wrap.setter
    def m_horizontal_wrap(self, m_horizontal_wrap: int) -> None: ...
    @property
    def m_mipmap_filtering(self) -> int: ...
    @m_mipmap_filtering.setter
    def m_mipmap_filtering(self, m_mipmap_filtering: int) -> None: ...
    @property
    def m_reserved(self) -> int: ...
    @m_reserved.setter
    def m_reserved(self, m_reserved: int) -> None: ...
    @property
    def m_texture(self) -> PySide6.QtQuick.QSGTexture: ...
    @m_texture.setter
    def m_texture(self, m_texture: PySide6.QtQuick.QSGTexture) -> None: ...
    @property
    def m_vertical_wrap(self) -> int: ...
    @m_vertical_wrap.setter
    def m_vertical_wrap(self, m_vertical_wrap: int) -> None: ...
...
class QSGRenderNode(PySide6.QtQuick.QSGNode):
    ...
    class RenderState(shiboken6.Shiboken.Object):
        ...
        def get(self, state: str, /) -> shiboken6.Shiboken.VoidPtr | None: ...
        def projectionMatrix(self, /) -> PySide6.QtGui.QMatrix4x4: ...
...
class QSGRendererInterface(shiboken6.Shiboken.Object):
    ...
    @typing.overload
    def getResource(self, window: PySide6.QtQuick.QQuickWindow, resource: PySide6.QtQuick.QSGRendererInterface.Resource, /) -> shiboken6.Shiboken.VoidPtr | None: ...
    @typing.overload
    def getResource(self, window: PySide6.QtQuick.QQuickWindow, resource: str, /) -> shiboken6.Shiboken.VoidPtr | None: ...
...
class QSharedPointer_QQuickItemGrabResult(shiboken6.Shiboken.Object):
    ...
    def __copy__(self, /) -> PySide6.QtQuick.QSharedPointer_QQuickItemGrabResult: ...
