...
class QQuickGraphicsDevice(Shiboken.Object):
    ...
    @staticmethod
    def fromDeviceAndContext(device: shiboken6.Shiboken.VoidPtr | Shiboken.Object, context: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> PySide6.QtQuick.QQuickGraphicsDevice: ...
    @staticmethod
...
class QQuickRenderTarget(Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def fromD3D11Texture(texture: shiboken6.Shiboken.VoidPtr | Shiboken.Object, pixelSize: PySide6.QtCore.QSize, /, sampleCount: int = ...) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromD3D11Texture(texture: shiboken6.Shiboken.VoidPtr | Shiboken.Object, format: int, pixelSize: PySide6.QtCore.QSize, /, sampleCount: int = ...) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromD3D11Texture(texture: shiboken6.Shiboken.VoidPtr | Shiboken.Object, format: int, pixelSize: PySide6.QtCore.QSize, sampleCount: int, flags: PySide6.QtQuick.QQuickRenderTarget.Flag, /) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromD3D12Texture(texture: shiboken6.Shiboken.VoidPtr | Shiboken.Object, resourceState: int, format: int, pixelSize: PySide6.QtCore.QSize, /, sampleCount: int = ...) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @typing.overload
    @staticmethod
    def fromD3D12Texture(texture: shiboken6.Shiboken.VoidPtr | Shiboken.Object, resourceState: int, format: int, viewFormat: int, pixelSize: PySide6.QtCore.QSize, sampleCount: int, arraySize: int, flags: PySide6.QtQuick.QQuickRenderTarget.Flag, /) -> PySide6.QtQuick.QQuickRenderTarget: ...
    @staticmethod
