...
class QAbstractEventDispatcher(PySide6.QtCore.QObject):
    ...
    def filterNativeEvent(self, eventType: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, message: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> typing.Tuple[bool, int]: ...
...
class QAbstractNativeEventFilter(Shiboken.Object):
    ...
    def nativeEventFilter(self, eventType: PySide6.QtCore.QByteArray | bytes | bytearray | memoryview, message: shiboken6.Shiboken.VoidPtr | Shiboken.Object, /) -> object: ...
...
class QGenericArgument(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, /, aName: bytes | bytearray | memoryview | None = ..., aData: shiboken6.Shiboken.VoidPtr | Shiboken.Object | None = ...) -> None: ...
